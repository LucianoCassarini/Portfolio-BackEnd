...
import com.portfolioapi.lgc.Entity.Educacion;
import com.portfolioapi.lgc.Service.SEducacion;
import com.portfolioapi.lgc.dto.dtoEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreEdu(), dtoeducacion.getDescripcionEdu(), dtoeducacion.getUrlImagenEdu(), dtoeducacion.getFechaEdu()
            );
    ...
    public ResponseEntity<?>  update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        educacion.setUrlImagenEdu(dtoeducacion.getUrlImagenEdu());
